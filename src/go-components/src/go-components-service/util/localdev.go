...
func createProductsTable() error {
	log.Println("Creating products table: ", DbTableProducts)
	...
	input := &dynamodb.CreateTableInput{
		...
		TableName: aws.String(DbTableProducts),
	}

	_, err := DynamoClient.CreateTable(input)
	if err != nil {
		log.Println("Error creating products table: ", DbTableProducts)
...
func createCategoriesTable() error {
	log.Println("Creating categories table: ", DbTableCategories)
	...
	input := &dynamodb.CreateTableInput{
		...
		TableName: aws.String(DbTableCategories),
	}

	_, err := DynamoClient.CreateTable(input)
	if err != nil {
		log.Println("Error creating categories table: ", DbTableCategories)
